...
function getCurrentDate(timeZone) {
  ...
  return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_12__["default"])(currentDate, 'eeee, MMMM dd, yyyy', {
    timeZone: timeZone
  });
}
...
function getFutureDays(timeZone) {
  ...
  for (var i = 1; i <= 5; i += 1) {
    ...
    next5Days.push((0,date_fns_format__WEBPACK_IMPORTED_MODULE_12__["default"])(nextDate, 'eeee', {
      timeZone: timeZone
    }));
  }
  return next5Days;
...
var weatherImageMap = {
  ...
  'scattered clouds': _img_weather_icons_broken_clouds_png__WEBPACK_IMPORTED_MODULE_2__,
...
function getFutureWeatherImageURL(weatherData, index) {
  ...
  var imageURL = weatherImageMap[weatherDescription] || "http://openweathermap.org/img/wn/".concat(weatherData.daily[index + 1].weather[0].icon, "@2x.png");
  return imageURL;
}
function getCurrentWeatherImageURL(weatherData) {
  var weatherDescription = weatherData.current.weather[0].description;
  var imageURL = weatherImageMap[weatherDescription] || "http://openweathermap.org/img/wn/".concat(weatherData.daily[0].weather[0].icon, "@2x.png");
  return imageURL;
}
...
module.exports = __webpack_require__.p + "assets/light-rain-086c2be4eb49eb0287ee.png";
