...
function setWeatherData(weatherData) {
  location.textContent = "".concat(weatherData.name, ", ").concat(weatherData.state);
...
function getLocalTime(weatherData) {
  ...
  var formattedTime = "".concat(hours);
