...
function getCurrentDate(timeZone) {
  ...
  return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(currentDate, 'eeee, MMMM dd, yyyy', {
    timeZone: timeZone
  });
}
...
function getFutureDays(timeZone) {
  ...
  for (var i = 1; i <= 5; i += 1) {
    ...
    next5Days.push((0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(nextDate, 'eeee', {
      timeZone: timeZone
    }));
  }
  return next5Days;
...
function setFutureWeatherData(weatherData) {
  ...
  futureForecastContainers.forEach(function (container, index) {
    ...
    var iconURL = "http://openweathermap.org/img/w/".concat(weatherData.daily[index + 1].weather[0].icon, ".png");
    futureDay.textContent = days[index];
    futureImage.style.background = "url(".concat(iconURL, ")");
