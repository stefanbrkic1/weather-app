...
/* harmony export */   handleFutureDaysTextLength: () => (/* binding */ handleFutureDaysTextLength),
...
function handleFutureDaysTextLength(weatherData) {
...
function displayWeatherData(weatherData) {
  ...
  setTextContent(minMaxTempContainer, "".concat(createMinMaxString(weatherData)));
