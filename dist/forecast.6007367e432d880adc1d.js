...
/* harmony export */ });
/* harmony import */ var date_fns_format__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! date-fns/format */ "./node_modules/date-fns/esm/format/index.js");
...
function getFutureDays(timeZone) {
  ...
  for (var i = 1; i <= 5; i += 1) {
    ...
    next5Days.push((0,date_fns_format__WEBPACK_IMPORTED_MODULE_31__["default"])(nextDate, 'eeee', {
      timeZone: timeZone
    }));
  }
  return next5Days;
...
function getCurrentDate(timeZone) {
  var currentDate = new Date();
  return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_31__["default"])(currentDate, 'eeee, MMMM dd, yyyy', {
    timeZone: timeZone
  });
}
